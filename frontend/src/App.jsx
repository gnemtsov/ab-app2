        ...
        if (tokens !== null) {
            ...
            if (currentTimestamp > tokenData.exp) {
                ...
                return this.gqlClient
                    ...
                    .then(response => {
                        console.log(
                            `App.refreshToken: access token refreshed, tokens in localStorage updated`
                        );
    ...
    render() {
        let routes = (
            <Switch>
                <Route
                    path="/login"
                    component={() => <Login isAuth={this.state.isAuth} login={this.login} />}
                />
                <Route
                    path="/add"
                    render={() => (
                        <p className={classes.UnAuthMessage}>
                            Please, authenticate to add departments.
                        </p>
                    )}
                />
                <Route
                    ...
                    render={() => (
                        <p className={classes.UnAuthMessage}>
                            Please, authenticate to edit departments.
                        </p>
                    )}
                />
                <Route
                    ...
                    render={() => (
                        <p className={classes.UnAuthMessage}>
                            Please, authenticate to see departments list.
                        </p>
                    )}
                />
                <Redirect to="/" />
